...
const AnnouncementModal: React.FC<AnnouncementModalProps> = ({ isOpen, onClose, announcement, language }) => {
  ...
  const getTranslated = (announcement: Announcement, field: 'title' | 'content') => {
  ...
  const title = getTranslated(announcement, 'title');
  const description = getTranslated(announcement, 'content');
