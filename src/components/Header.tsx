...
import schoolLogo from '../assets/logo_with_name.png'; // Ensure you have a logo image in the specified path
        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          >
            ...
            <div className="hidden lg:block">
              <h1 className="text-lg font-semibold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent leading-tight">{t['Ehsan Panhwer Coaching Center']}</h1>
