  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: "Address",
      details: "EPCC, Near Panhwar flour mill, Panhwar Colony, Pak Colony, Mīrpur Khās, Pakistan",
      color: "text-blue-500"
    },
    {
      icon: Phone,
      title: "Phone",
      details: "+92 345 3180686",
    ...
    },
    {
      icon: Clock,
      title: "Hours",
      details: "Mon - Sat: 3:00 PM - 8:00 PM",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <motion.div
              ...
              className="mt-12"
            >
              <h3 className="text-2xl font-bold text-foreground mb-6">{t['Our Campus']}</h3>
              <div className="aspect-w-16 aspect-h-9 rounded-2xl overflow-hidden border border-border/50">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d267.64013477033103!2d69.0139825633598!3d25.50764514585112!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2s!4v1759057417448!5m2!1sen!2s"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
