...
import schoolLogo from '../assets/logo_without_name.png';
...
export function Footer({ language }: FooterProps) {
  const translations = {
    'English': {
      'Ehsan Panhwer Coaching Center': 'Ehsan Panhwer Coaching Center',
    ...
    'Sindhi': {
      'Ehsan Panhwer Coaching Center': 'احسان پنهور ڪوچنگ سينٽر',
    ...
    'Urdu': {
      'Ehsan Panhwer Coaching Center': 'احسان پنہوور کوچنگ سینٹر',
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                <motion.img 
                  ...
                  transition={{ duration: 0.8 }}
                  src={schoolLogo} 
                  alt="Ehsan Panhwer Coaching Center" 
                  className="h-12 w-12 object-contain"
                />
                <div>
                  <h3 className="text-lg font-bold">{t['Ehsan Panhwer Coaching Center']}</h3>
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span className="opacity-80">EPCC, Near Panhwar flour mill, Panhwar Colony, Pak Colony, Mīrpur Khās, Pakistan</span>
                </motion.div>
                <motion.div 
                  whileHover={{ x: 5 }}
                ...
                >
                  ...
                  <span className="opacity-80">+92 345 3180686</span>
                </motion.div>
                <motion.div 
                  whileHover={{ x: 5 }}
                  className="flex items-center space-x-3 text-sm"
                ...
                >
                  ...
                  <span className="opacity-80">Mon - Sat: 3:00 PM - 8:00 PM</span>
                </motion.div>
              </div>
            </motion.div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex flex-col sm:flex-row justify-between items-center text-center sm:text-left">
              <p className="text-sm opacity-80 mb-4 sm:mb-0">
                © {new Date().getFullYear()} {t['Ehsan Panhwer Coaching Center']}. {t['All rights reserved']}.
              </p>
